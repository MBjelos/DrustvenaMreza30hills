...
for(i=0; i<obj.length; i++){
	...
	for(n=0; n<len.length; n++){
		...
		// pod zadata: prijatelji prijatelja
...
//pod zdatak: predlozeni prijatelji
for(i=0; i<obj.length; i++){
	var sugg = [];
